...
public class Implication {
	...
	private String wordOneDiacritized, wordOneUndiacritized, wordTwoDiacritized, wordTwoUndiacritized, wordOneOrig, wordTwoOrig;
	private char[] wordOneCharArray, wordTwoCharArray;
	...
	public Implication(String input1, String input2){
		...
		this.wordOneDiacritized = input1.replaceAll("\u0625", "\u0627<").replaceAll("\u0623", "\u0627>").replaceAll("\u0671", "\u0627").trim();
	...
	public String getImplicationDistance(){
		int implication = checkImplication();
		int distance = -1;
		String result = "";
		if(implication == 0 || implication == -1 || implication == 101){
			result += "Not Found\t";
			if(implication == -1 || implication == 101){
				distance = 101;
				result += "Sure\t";
			} else {
		...
		return result + implication + "\t" + distance + "\t" + conflictCount;
	}
	...
	public String toString(){
		return  "Word One: \n" + this.wordOneDiacritized + "\t" + this.wordOneUndiacritized + "\n" +
